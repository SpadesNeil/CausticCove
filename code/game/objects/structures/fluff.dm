...
/obj/structure/fluff/wallclock/attack_right(mob/user) // Caustic Edit - This whole rightclick action was an old version of the stash code that didn't apply any dyes. Replaced with the proper call.
	handle_special_items_retrieval(user, src)
	return
